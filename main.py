...
tags = [post['tags'] for post in posts_metadata]
home_html = home_template.render(posts=posts_metadata, tags=tags)
# ekki output heldur upp úr vinnumöppuni og á nýja
with open('../recipes/posts/index.html', 'w') as file:
    file.write(home_html)
...
for post in POSTS:
    ...
    post_html = post_template.render(post=post_data)
    post_file_path = '../recipes2/posts/{slug}.html'.format(slug=post_metadata['slug'])
